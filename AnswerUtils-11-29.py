...
class LessonQA:
    ...
    def _get_keys(self):
        lessonQA_keys = self.lesson_qa_df[['course','lesson']].drop_duplicates()
    ...
    def get_answers_by_key(self, lessonQA_key_pd):
        lesson_dialogue_pd = pd.merge(self.lesson_qa_df, lessonQA_key_pd, how="inner")
        return lesson_dialogue_pd.sort_values(by=['createdTime'], ascending=True)
    ...
    def get_QAs(self, lesson_dialogue_pd):
        ...
        return pd.DataFrame(qa_diaglog, columns=['q_id', 'a_id', 'q',  'a'])
